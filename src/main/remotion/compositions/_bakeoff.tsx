...
import { AccentLine, DarkCard, GlowDot, GridOverlay } from '../shared/primitives';
...
export const BakeoffAuroraGlass: React.FC<BakeoffProps> = (p) => {
  ...
  return (
    <AbsoluteFill
      style={{ backgroundColor: BRAND_BG, justifyContent: 'center', alignItems: 'center' }}
    >
      <PrestyjFonts />
...
export const BakeoffEditorial: React.FC<BakeoffProps> = (p) => {
  ...
  return (
    <AbsoluteFill
      style={{ backgroundColor: BRAND_BG, justifyContent: 'center', padding: '0 150px' }}
    >
      <PrestyjFonts />
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontFamily: 'Bebas Neue', fontSize: 128, lineHeight: 0.95, color: BRAND_FG }}>
          {props.heading}
        </div>
      </div>
