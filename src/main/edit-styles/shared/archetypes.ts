...
import type { SegmentStyleCategory, TransitionType } from '@shared/types';
...
export const ARCHETYPE_META: Record<Archetype, { name: string; description: string }> = {
  'talking-head': {
    name: 'Talking Head',
 ...
 */
export function categoryToDefaultArchetype(category: SegmentStyleCategory): Archetype {
  switch (category) {
    case 'main-video':
      return 'talking-head';
